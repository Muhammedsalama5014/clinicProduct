<?php include("inc/header.php");?>
                ...
                <div class="d-table"> 
                    <div class="d-tablecell"> 
                        <div class="hero-text text-center">
                            ...
                            <a href="#" class="default-btn">Appointment Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="single-services">
                            ...
                            <p>Our talented, board-certified plastic surgeons have more than 10 years of experience.</p>
                        </div>
                    </div>
        ...
        <!-- Departments section -->
        <section class="department-area ptb-100 gray-bg"> 
            <div class="container"> 
                <div class="section-title">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="tabs_item_img">
                                                <img src="assets/img/department/department-img1.jpg" alt="department">
                                            </div>
                                        </div>
