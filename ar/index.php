...
<!-- Mirrored from templates.envytheme.com/promedi/rtl/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Apr 2023 17:14:53 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                            ...
                            <ul class="navbar-nav m-auto">
                                <li class="nav-item active dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item active" href="index.html">Home Demo 1</a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="department-details.php">Cardiology</a>
                                        <a class="dropdown-item" href="department-details.php">Gynecology</a>
                                        <a class="dropdown-item" href="department-details.php">Neurology</a>
                                        <a class="dropdown-item" href="department-details.php">Orthopedics</a>
                                        <a class="dropdown-item" href="department-details.php">Gastrology</a>
                                        <a class="dropdown-item" href="department-details.php">Pulmonology</a>
                                        <a class="dropdown-item" href="department-details.php">Laboratory</a>
                                        <a class="dropdown-item" href="department-details.php">Urology</a>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="blog-details.php">Single Blog</a>
                                    </div>
                                </li>
                ...
                <div class="row"> 
                    <div class="col-md-6 col-lg-4"> 
                        <div class="single-card">
                            <div class="thumb-img">
                                <img src="assets/img/services/1.jpg" alt="Service Image" />
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4"> 
                        <div class="single-card">
                            <div class="thumb-img">
                                <img src="assets/img/services/2.jpg" alt="Service Image" />
                            </div>
            ...
            <div class="container"> 
                ...
                <div class="latest-news-carousel owl-carousel owl-theme owl-theme-2">
                    ...
                    <div class="single-card actical-card">
                        <div class="thumb-img">
                            <a href="#">
                                <img src="assets/img/news/3.jpg" alt="News Image" />
                            </a>
                        </div>
                    ...
                    <div class="single-card actical-card">
                        <div class="thumb-img">
                            <a href="#">
                                <img src="assets/img/news/4.jpg" alt="News Image" />
                            </a>
                        </div>
                    ...
                    <div class="single-card actical-card">
                        <div class="thumb-img">
                            <a href="#">
                                <img src="assets/img/news/5.jpg" alt="News Image" />
                            </a>
                        </div>
            ...
            <div class="container">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-3">
                        <div class="footer-widget">
                            ...
                            <div class="foot-contact-info">
                                ...
                                <p><a href="https://templates.envytheme.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9ff6f1f9f0dfefedf0f2fafbf6b1fcf0f2">[email&#160;protected]</a> <br> <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="512224213e23251121233e3c3435387f323e3c">[email&#160;protected]</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row bottom-footer">
                    <div class="col-md-6 col-lg-6">
                        <p>Copyright @ 2021, Promedi. All rights reserved.</p>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <ul>
...
<!-- Mirrored from templates.envytheme.com/promedi/rtl/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 05 Apr 2023 17:15:18 GMT -->
</html>